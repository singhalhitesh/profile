...
<html lang="en">
    ...
    <body class="white_bg">
        ...
        <div class="content-area work-area">
            <div class="container">
            	<div class="">
                	<h1 class="col-lg-12 title"><span>Select Web Projects</span></h1>
                	<div>
                        <div class="project three columns col-xs-6 col-sm-6 col-md-3 col-lg-3" id="b26034369">
                        	<a class="wrapping" href="#32258529" data-project-id="32258529">
                                <img class="img-responsive" src="assets/images/projects/maven.jpg" alt="imaginary museum" />
                                <div class="info">
                                    <h2 class="name">Maven, 2012</h2>
                                </div>
                            </a>
                        </div>
                        
                        <div class="project three columns col-xs-6 col-sm-6 col-md-3 col-lg-3" id="b26097217">
                        	<a class="wrapping" href="#26097217" data-project-id="26097217">
                                <img class="img-responsive" src="assets/images/projects/speakeasy.jpg" alt="imaginary museum" />
                                <div class="info">
                                    <h2 class="name">Speakeasy, 2014</h2>
                                </div>
                            </a>
                        </div>
                ...
                <h1 class="col-lg-12 title"><span>Web Archive</span></h1>
